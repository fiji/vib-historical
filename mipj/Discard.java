...
public class Discard
{
	...
	public Discard(MIPImageStack is) {
		stack = is;
	...
	/** Discards (by setting to zero) all voxels in which every
	    neighbour is greater than itself. This tends to remove a
	    small amount (<10%). */
	...
	/** Sends a "front" through the dataset, maintaining the
	    minimum value possible for the maximum intensity as it
	    goes, to calculate a dataset which is used for real-time
	    projection.. */
